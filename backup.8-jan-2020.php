...
/*All Departure City*/
$departure_query = " SELECT add_on_price.* FROM add_on_price left join mastcity.";
...
/*echo "<pre/>"; print_r($departure);die();*/
                  ...
                  <div class="col-md-3">
                     <div class="order-booking-right">
                        ...
                        <div class="paymenyopt1">
                           <center>
                              <h3 class="" id="packprice"><?=$_SESSION['final_cost']=$packages[0]["std_final_price"]?><br><span id="gst_include" style="font-size: 12px;
                              color: #5a5a5a;">Including With Gst</span></h3>
        ...
        $('#add_room').click(function()
        {
         if (srNo >= 2) 
         {
            ...
            $("#add_room").attr("disabled", "disabled");
                                             alert("You Can Not Add More Than Two Rooms");
                                          }
